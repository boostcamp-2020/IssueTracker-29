module.exports = {
  ...
  READ_COMMENT: 'select id, contents, created_at, user_id from comment where issue_id = ?;',
  ...
  READ_ALL_USER: 'select username from user;',
  ...
  UPDATE_ISSUE_STATE: 'update issue set is_open = ? where id in (?);',
